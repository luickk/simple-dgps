...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref "v3.5.2"
  WORKING_DIRECTORY "/Users/luickklippel/Documents/projekte/simple-dgps/include/cc.ublox.commsdsl/include/cc.ublox.commsdsl/externals/commsdsl"
...
if("${show_ref_output}" MATCHES "refs/remotes/v3.5.2")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v3.5.2")
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/commschamp/commsdsl.git'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/Users/luickklippel/Documents/projekte/simple-dgps/include/cc.ublox.commsdsl/include/cc.ublox.commsdsl/externals/commsdsl'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/luickklippel/Documents/projekte/simple-dgps/include/cc.ublox.commsdsl/include/cc.ublox.commsdsl/externals/commsdsl'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
